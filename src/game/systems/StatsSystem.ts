...
export const criticalChance=(agility:number)=>agility*GAME_CONFIG.player.critical.agilityMultiplier;
...
export const basePowerDamage=(powerType:PowerType,stats:Stats)=>powerType==="magic"?MAGE_CONFIG.damage.baseDamage+stats.intelligence*MAGE_CONFIG.damage.intelligenceMultiplier:(powerType==="archer"?stats.agility:stats.intelligence)*GAME_CONFIG.player.attack.powerStatMultiplier;
...
export const attackRange=(powerType:PowerType)=>powerType==="magic"?MAGE_CONFIG.combat.range:GAME_CONFIG.player.attack.rangeByPower[powerType];
