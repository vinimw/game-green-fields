...
export type AutoplayDecision={mode:'coins'|'hunt'|'attack'|'retreat'|'idle';destination?:Vec2;monsterId?:string};
...
export class AutoplaySystem{
  decide(player:PlayerState,position:Vec2,monsters:AutoplayMonster[],coins:Vec2[]):AutoplayDecision{
